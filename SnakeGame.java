...
public class SnakeGame extends JPanel implements ActionListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) { //called every x milliseconds by gameLoop timer
        ...
        if (gameOver) {
            ...
            int choice = JOptionPane.showOptionDialog(null, "Game Over!\n\nDo you want to play again?", 
                            "Snake Game", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
    ...
    public static void main(String[] args) {
        ...
        SnakeGame game = new SnakeGame(500, 500); // Ganti 500 dengan lebar dan tinggi papan permainan yang diinginkan
        frame.add(game);
        frame.pack();
